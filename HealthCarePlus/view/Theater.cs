    ...
    public partial class Theater : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bool isRegistrationSuccessful = theaterController.RegisterTheater(
                    txtName.Text, txtprice.Text, txtMax.Text, txtSpecific.Text,
                    cmbStatus.SelectedItem.ToString(), cmbType.SelectedItem.ToString());
        ...
        private void table_load()
        {
            ...
            try
            {
                DataTable dataTable = theaterController.LoadTheaterData();
        ...
        || string.IsNullOrEmpty(txtprice.Text) || string.IsNullOrEmpty(cmbType.SelectedItem.ToString()))
            ...
            bool isUpdateSuccessful = theaterController.UpdateTheater(
                txtId.Text, txtName.Text, txtprice.Text, txtMax.Text, txtSpecific.Text,
                cmbStatus.SelectedItem.ToString(), cmbType.SelectedItem.ToString());
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            TheaterData theater = theaterController.GetTheaterById(int.Parse(txtId.Text));

            if (theater != null)
            {
                txtName.Text = theater.Name;
                txtprice.Text = theater.Price.ToString();
                txtMax.Text = theater.MaxPatient.ToString();
                txtSpecific.Text = theater.Specification;
                cmbStatus.SelectedItem = theater.Status;
                cmbType.SelectedItem = theater.Type;
            }
            else
            {
                MessageBox.Show("Theater record not found.");
            }
        }
